...
const PanelInicio = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-2xl shadow-md">
      <h2 className="text-2xl font-semibold text-gray-800 mb-6">Bienvenido al Panel de Turista</h2>
      <p className="text-gray-600 mb-8">
        Aquí puedes gestionar las tareas clave del área de Turismo de forma organizada.
      </p>
